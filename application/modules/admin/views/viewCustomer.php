        ...
        <div class="col-md-12">
            ...
            <section class="tile">
                ...
                <div class="tile-header dvd dvd-btm">
                    <h1 class="custom-font"><strong>View Customer  </strong></h1>
                ...
                <div class="tile-body">
                   ...
                   <?php  $test =  $customer_data->security_que_ans ; 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $value['answer']; ?>"  class="form-control" id="answer<?php echo $answer; ?>" readonly  name="answer<?php echo $icount; ?>">
                    </div>
                  <?php $icount++;   } ?>
