<div class="page page-tables-datatables">
    ...
    <div class="pageheader">
        ...
        <h2>Services <span>Services ELJEBO</span></h2>
        ...
        <div class="col-md-12">
            ...
            <section class="tile">
                ...
                <div class="tile-header dvd dvd-btm">
                    ...
                    <ul class="controls">
                        <li><a role="button" tabindex="0" id="add-entry" href="<?php echo site_url();?>admin/add_service"><i class="fa fa-plus mr-5"></i> Add Entry</a></li>
                    </ul>
                </div>
                <!-- /tile header -->
