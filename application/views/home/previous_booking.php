		...
		<section class="Dashboard_section">
			<div class="container_dashboard">
				<div class="left_menu_dashboard">
					<div class="tab_container desk">
						...
						<div class="top_bar_heading">
						    <button class=" tablink tab_heading " onclick="openCity(event,'Upcoming_Bookings')">Upcoming Bookings</button>
						    <button class="tab_heading tablink active_tab" onclick="openCity(event,'Previous_Bookings')">Previous Bookings</button>
						  ...
						  <div id="Upcoming_Bookings" class="w3-container w3-border city" style="display: none;">
						  ...
						  <div id="Previous_Bookings" class="w3-container w3-border city" style="display:block;">
					...
					<nav class="mob_nav menus">
						...
						<div class="tab_container mobile">
							...
							<div class="top_bar_heading">
							    <button class=" tablink tab_heading" onclick="openCity(event,'Upcoming_Bookings_02')">Upcoming Bookings</button>
							    <button class="tab_heading tablink  active_tab" onclick="openCity(event,'Previous_Bookings_02')">Previous Bookings</button>
				...
				<div class="main_content_dashboard">
					 <div class="tab_con_row previous_booking_user  show_tab">
						    	<div class="tab_con_container">
						    		<span class="img_ico">
						    			<img src="images/02.png">
						    			<span class="ratings"><i class="fa fa-star"></i>4.7</span>
						    		</span>
						    		<div class="txt_container">
							    		<h6>Nails</h6>
							    		<span>Suky Gill</span>
						    	...
						    	<a href="" class="btn_green">Rebook appointment</a>
						    </div>
						    <!-- tab_con_row end -->			
