    ...
    <div class="row">
	    ...
	    <div class="jumbotron">
	      <div class="container-fluid">
	        ...
	        <p>This project will guide you to integrate International Payment Gateway "Stripe" in Codeigniter <span class="badge bg-primary badge-pill"><?php echo CI_VERSION; ?></span> with Bootstrap 4. Understand how Stripe Gateway works and implement to your web/app accordingly. if you need any minor help <a href="<?php echo base_url(); ?>payment/help">contact us</a> here. You can also use Learn more button below</p>
	        <p><a class="btn btn-primary btn-lg" href="<?php echo base_url(); ?>payment/help" role="button">Learn more &raquo;</a></p>
	      </div>
	    </div>
    </div>
</div>
