...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	...
	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				<a href="<?php echo base_url(); ?>payment/help" class="nav-link">Help Article</a>
			</li>
				...
				<div class="card-body">
					<div style="line-height:3rem">
						...
						<ol>
							...
							<li> Copy<code>payment.php</code> controller file in your <code>applications/controllers/</code>directory</li>
							...
							<li> Replace your Secret key & Publishable key in <code>applications/controller/payment.php</code> on <code>line 30, 31</code></li>
					...
					<div class="card-footer">
						...
						<ol>
							<li><em>payment.php</em> Controller - Displays the product_form.php view page.</li>
							<li><em>payment.php/check</em> Method -  Check all parameters required for transaction and process the payment..</li>
							<li><em>payment.php/help</em> Method - Displays the quick integration help page.</li>
						</ol>
					</div>
				</div>
			</div>
